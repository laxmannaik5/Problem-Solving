...
int main(){
    ...
    //not applicable
    // cout<<upper_bound(arr.begin(), arr.end(),3)<<endl; <--return an iterator to 1st position of 3
    // cout<<lower_bound(arr.begin(), arr.end(),3)<<endl; <--return an iterator to next to the last position of 3 i.e 4
